...
# CMD gunicorn --workers 1 --bind 0.0.0.0:$PORT --timeout 120 api.index:app
# CMD ["gunicorn", "--workers", "4", "--bind", "0.0.0.0:8000", "api.index:app"]
CMD ["gnicorn", "--workers", "1", "--bind", "0.0.0.0:8000", "--timeout", "300", "api.index:app"]